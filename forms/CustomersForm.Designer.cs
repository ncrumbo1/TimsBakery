...
namespace TimsBakery.forms
{
   partial class CustomersForm
   {
      ...
      private void UpdatePreview()
      {
         ...
         {
            sb.AppendLine($"Name: {txtFirstName.Text} {txtLastName.Text}".Trim());
         }
         ...
         if (!string.IsNullOrWhiteSpace(txtAddress.Text) || !string.IsNullOrWhiteSpace(txtCity.Text) ||
             !string.IsNullOrWhiteSpace(txtState.Text) || !string.IsNullOrWhiteSpace(txtZip.Text))
         {
            sb.AppendLine($"Address: {txtAddress.Text}, {txtCity.Text}, {txtState.Text} {txtZip.Text}".Trim(new char[] { ',', ' ' }));
         }

         if (!string.IsNullOrWhiteSpace(txtLoyalty.Text))
         {
            sb.AppendLine($"Loyalty: {txtLoyalty.Text}");
         }
