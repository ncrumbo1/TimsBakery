...
namespace TimsBakery.forms
{
   partial class InventoryForm
   {
      ...
      private void InitializeComponent()
      {
         ...
         AddLabeledControl(panel1, "Store ID:", txtStoreID, 10, ref y, spacing);
         ...
         this.txtStoreID.TextChanged += (s, e) => UpdatePreview();
      ...
      private void UpdatePreview()
      {
         ...
         {
            sb.AppendLine($"Product ID: {txtProductID.Text}");
         }

         if (!string.IsNullOrWhiteSpace(txtStoreID.Text))
         {
            sb.AppendLine($"Store ID: {txtStoreID.Text}");
         }

         if (!string.IsNullOrWhiteSpace(txtQuantity.Text))
         {
            sb.AppendLine($"Quantity: {txtQuantity.Text}");
         }

         if (!string.IsNullOrWhiteSpace(txtInventoryUpdate.Text))
         {
            sb.AppendLine($"Last Updated: {txtInventoryUpdate.Text}");
         }
